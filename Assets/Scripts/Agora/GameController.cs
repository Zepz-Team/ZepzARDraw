...
public class GameController : MonoBehaviour
{
    ...
    private void LoadLastChannel()
    {
        ...
        {
            GameObject go = GameObject.Find("inputPassword");
    ...
    private void InitializeRTCObject()
    {
        // init engine
        ...
        Debug.Log("Agora RTC SDK Version: " + IRtcEngine.GetSdkVersion());
    }
    ...
    public void OnJoinButtonClicked(int mode)
    {
        ...
        {
            app = new BroadcasterVC(AppID);
        }
        else
        {
            app = new AudienceVC(AppID, mode == 2);
        }
